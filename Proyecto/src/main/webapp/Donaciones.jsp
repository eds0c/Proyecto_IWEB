        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <!-- DONACION -->
                    <li class="active"><a class="text-decoration-none" href="<%=request.getContextPath() %>/AlumnoServlet?action=donaciones"><i class="bi bi-heart-fill"></i><span>Donaciones</span></a>
                    </li>
                ...
                <div class="row mt-2">
                    <div class="col-sm-12">
                        <p style="text-align: justify;">
                            En el caso de que el usuario sea un egresado de la facultad de Telecomunicaciones, se establece un monto mínimo de donación de 100 soles.
                            ...
                            las actividades promovidas por la institución.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-10 mx-auto">
                    <div class="blog-view">
                        <article class="blog blog-single-post">
                            <form method="POST" action="<%=request.getContextPath()%>/AlumnoServlet?action=donar" enctype="multipart/form-data">
                                <!-- Medio de pago -->
