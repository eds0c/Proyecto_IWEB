        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <div class="mt-5">
                            <h4 class="card-title float-left mt-2">Usuarios Baneados</h4>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <table class="table table-hover mt-1 mb-1">
                                    ...
                                    <%if (listaUsuariosBaneados.isEmpty()) {%>
                                    <p class="lead">No existen usuarios baneados</p>
                                    <%}%>

                                    <tbody>
                                    <%int i = (currentPageJsp - 1) * (10) + 1;%>
                                    <%for (Alumno alumno : listaUsuariosBaneados) {%>
                                    <tr>
                                        <td><%=i%>
                                        </td>
                                        ...
                                        <div class="modal fade" id="aceptar<%=i%>" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Alumno desbaneado
                                                        </h5>
                                    ...
                                    <div class="col">
                                        <nav aria-label="Page navigation example">
                                            <ul class="pagination justify-content-center">
                                                ...
                                                <li class="page-item">
                                                    <a class="page-link" href="<%=request.getContextPath() %>/DelegadoGeneralServlet?action=usuarios_baneados&currentPage=<%=auxStart%>" aria-label="Previous">
                                                        <span aria-hidden="true">&laquo;</span>
                                                    </a>
                                                </li>
                                                <%for (int j=1;j<=cantidadPaginas;j++){%>
                                                <%if(currentPageJsp == j){%>
                                                <li class="page-item"><a class="page-link active" href="<%=request.getContextPath() %>/DelegadoGeneralServlet?action=usuarios_baneados&currentPage=<%=j%>"><%=j%></a></li>
                                                <%} else {%>
                                                ...
                                                <%}%>
                                                <li class="page-item">
                                                    <a class="page-link" href="<%=request.getContextPath() %>/DelegadoGeneralServlet?action=usuarios_baneados&currentPage=<%=auxEnd%>" aria-label="Next">
