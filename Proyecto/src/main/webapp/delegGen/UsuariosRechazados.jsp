...
<jsp:useBean id="listaUsuariosRechazados" scope="request" type="ArrayList<com.example.proyecto.beans.Alumno>"/>
...
<head>
    ...
    <title>Usuarios Rechazados</title>
                    ...
                    <li class="submenu"><a class="text-decoration-none" href="#"><i class="fas fa-user"></i> <span> Usuarios </span>
                        ...
                        <ul class="submenu_class" style="display: none;">
                            ...
                            <li><a class="active text-decoration-none"
                                   href="<%=request.getContextPath() %>/DelegadoGeneralServlet?action=usuarios_rechazados">
                                Rechazados </a></li>
                            <li><a class="text-decoration-none"
                                   href="<%=request.getContextPath() %>/DelegadoGeneralServlet?action=usuarios_baneados">
                                Baneados </a></li>
                        ...
                        <ul class="submenu_class" style="display: none;">
                            <li>
                                <a class="text-decoration-none"
                                   href="<%=request.getContextPath() %>/DelegadoGeneralServlet?action=validar_donaciones">Por
                                    verificar </a>
                            </li>
                            <li><a class="text-decoration-none"
                            ...
                            <li><a class="text-decoration-none"
                                   href="<%=request.getContextPath() %>/DelegadoGeneralServlet?action=donaciones_rechazadas">No
                                validadas</a></li>
        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <div class="mt-5">
                            <h4 class="card-title float-left mt-2">Usuarios rechazados</h4>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <table class="table table-hover mt-1 mb-1">
                                    ...
                                    <%if (listaUsuariosRechazados.isEmpty()) {%>
                                    <p class="lead">No existen usuarios rechazados</p>
                                    <%}%>

                                    <tbody>
                                    <%int i = (currentPageJsp - 1) * (10) + 1;%>
                                    <%for (Alumno alumno : listaUsuariosRechazados) {%>
                                    <tr>
                                        <td><%=i%>
                                        </td>
                                                ...
                                                <div class="modal-content">
                                                    <form>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mb-3">
                                                                <h6 class="fw-bold">Motivo de rechazo:</h6>
                                    ...
                                    <div class="col">
                                        <nav aria-label="Page navigation example">
                                            <ul class="pagination justify-content-center">
                                                ...
                                                <li class="page-item">
                                                    <a class="page-link" href="<%=request.getContextPath() %>/DelegadoGeneralServlet?action=usuarios_rechazados&currentPage=<%=auxStart%>" aria-label="Previous">
                                                        <span aria-hidden="true">&laquo;</span>
                                                    </a>
                                                </li>
                                                <%for (int j=1;j<=cantidadPaginas;j++){%>
                                                <%if(currentPageJsp == j){%>
                                                <li class="page-item"><a class="page-link active" href="<%=request.getContextPath() %>/DelegadoGeneralServlet?action=usuarios_rechazados&currentPage=<%=j%>"><%=j%></a></li>
                                                <%} else {%>
                                                <li class="page-item"><a class="page-link" href="<%=request.getContextPath() %>/DelegadoGeneralServlet?action=usuarios_rechazados&currentPage=<%=j%>"><%=j%></a></li>
                                                <%}%>
                                                <%}%>
                                                <li class="page-item">
                                                    <a class="page-link" href="<%=request.getContextPath() %>/DelegadoGeneralServlet?action=usuarios_rechazados&currentPage=<%=auxEnd%>" aria-label="Next">
